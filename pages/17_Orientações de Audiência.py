...
def enviar_email():
    ...
    caminho_imagem = os.path.join(BASE_DIR, IMG_DIR, 'Orientações de audiência.png') # mudar o nome da img
    ...
    for i, contato in enumerate(df['EMAIL']):
        ...
        email.Subject = f"Auditoria CJ - Orientações de Audiência - {indice}"
...
st.markdown("### Envio Automático de E-mails - Orientações de Audiência")

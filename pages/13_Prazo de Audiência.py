...
def enviar_email():
    ...
    caminho_imagem = os.path.join(BASE_DIR, IMG_DIR, 'Prazo de audiencia.png') # mudar o nome da img
    ...
    for i, contato in enumerate(df['EMAIL']):
        ...
        email.Subject = f"Auditoria CJ - Prazo de Audiência - {indice}"
...
st.markdown("### Envio Automático de E-mails - Prazo de Audiência")

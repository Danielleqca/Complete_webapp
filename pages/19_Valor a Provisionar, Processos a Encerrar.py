...
def enviar_email():
    ...
    caminho_imagem = os.path.join(BASE_DIR, IMG_DIR, 'Valor a provisionar a encerrar.png') # mudar o nome da img
    ...
    for i, contato in enumerate(df['EMAIL']):
        ...
        email.Subject = f"Auditoria CJ - Valor a Provisionar, Processos a Encerrar - {indice}"
...
st.markdown("### Envio Automático de E-mails - Valor a Provisionar, Processos a Encerrar")

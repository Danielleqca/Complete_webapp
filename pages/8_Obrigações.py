...
def enviar_email():
    ...
    caminho_imagem = os.path.join(BASE_DIR, IMG_DIR, 'Obrigações.png') # mudar o nome da img
    ...
    for i, contato in enumerate(df['EMAIL']):
        ...
        email.Subject = f'Auditoria CJ - Obrigações - {indice}'
...
st.markdown("### Envio Automático de E-mails - Obrigações")

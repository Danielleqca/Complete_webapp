...
def enviar_email():
    ...
    caminho_imagem = os.path.join(BASE_DIR, IMG_DIR, 'Revisao.png') # mudar o nome da img
    ...
    for i, contato in enumerate(df['EMAIL']):
        ...
        email.Subject = f"Auditoria CJ - Revisão - {indice}"
...
st.markdown("### Envio Automático de E-mails - Revisão Cadastro")

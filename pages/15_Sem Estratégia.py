...
def enviar_email():
    ...
    caminho_imagem = os.path.join(BASE_DIR, IMG_DIR, 'Sem Estratégia.png') # mudar o nome da img
    ...
    for i, contato in enumerate(df['EMAIL']):
        ...
        email.Subject = f"Auditoria CJ - Sem Estratégia - {indice}"
...
st.markdown("### Envio Automático de E-mails - Sem Estratégia")
